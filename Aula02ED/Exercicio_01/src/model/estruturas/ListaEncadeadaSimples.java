...
public class ListaEncadeadaSimples<T> {
	...
	// index		Retorna um indíce de um elemento;
	// insert		Insere um elemento de uma determinada posição
	...
	public No<T> get(int index) throws IllegalArgumentException {
		...
		if (i < index)
			throw new IllegalArgumentException("O indíce informado não existe.");
		return buffer;
	}
	...
	public void remove(int index) {
		...
		No<T> buffer_anterior = this.get(index - 1); // --index 
